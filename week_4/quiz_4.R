    ...
    # 1. Question 1 What is produced at the end of this snippet of R code?
    set.seed(1)
    rpois(5, 2)
    ...
    # 7. What aspect of the R runtime does the profiler keep track of when
    ...
    ## it's the time spent by the CPU evaluating an expression
    
    # 10. If a computer has more than one available processor and 
    # R is able to take advantage of that, then which of the following 
    # is true when using 'system.time()'?
